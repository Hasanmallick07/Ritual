...
function main_menu() {
    while true; do
        clear
        echo "Script written by Big Gambling Community, Twitter @ferdie_jhovie, open source and free, don't trust paid versions"
        echo "For issues, contact on Twitter, this is the only account"
        echo "Thanks to Yan Buyouzhong for code contributions"
        echo "================================================================"
